...
def main():
    source_dir_with_jpg = '/home/rokey/rokey_ping_ws/to_students/my_data/train/images'
    source_dir_with_txt = '/home/rokey/Downloads/sungjun_L'
    target_dir = './my_data/train/labels'

    move_corresponding_txt_files(source_dir_with_jpg, source_dir_with_txt, target_dir)

    source_dir_with_jpg = '/home/rokey/rokey_ping_ws/to_students/my_data/valid/images'
